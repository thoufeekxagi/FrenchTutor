...
import 'package:french_tutor/widgets/web/web_app_shell.dart';

void main() {
  testWidgets(
    'WebAppShell renders sidebar destinations and switches body on tap',
    (tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(
          home: StatefulBuilder(
            builder: (context, setState) => WebAppShell(
