...
class SpeakingTranslationAlignment {
  ...
  static List<List<int>> forPhrase(String source, String translation) {
    ...
    for (var sourceIndex = 0; sourceIndex < sourceWords.length; sourceIndex++) {
      ...
      if (matches.isEmpty &&
          _isNonLexicalFreeTalkWord(sourceWords[sourceIndex])) {
        // Some French function words are intentionally absorbed into the
        // surrounding English phrase (for example “par” in “par semaine”).
        // They remain unpaired rather than being pointed at an unrelated
        // English token.
        continue;
      }
  ...
  static const _contextualMeanings = <String, List<String>>{
    ...
    'aller retour': ['return'],
    'animal': ['pet', 'animal'],
    'autre': ['another', 'else', 'other'],
    'aussi': ['too', 'also'],
    'banc': ['bench'],
    'bien': ['very', 'well', 'of course', 'good'],
    'clients': ['customers', 'clients'],
    'compte': ['account'],
    'couvre': ['cover', 'covers'],
    'après midi': ['afternoon'],
    'beaucoup': ['plenty', 'very much'],
    'aide': ['helps', 'help'],
    'aider': ['helping', 'help'],
    'appartement': ['apartment'],
    'activité': ['activity'],
    'avez vous': ['do you have', 'have you', 'do you need'],
    'avons': ['have'],
    'combien': ['how long', 'how much', 'how many'],
    'commence': ['start', 'starts', 'begin'],
    'contacterons': ['contact'],
    'conseille': ['recommend'],
    'conseillez vous': ['do you recommend', 'recommend'],
    'cherchez vous': ['are you looking for', 'looking for'],
    'cherchez': ['looking for', 'look'],
    'cuisine': ['cook'],
    'cuisinez': ['cook'],
    'clé': ['key'],
    'coûte': ['costs', 'is'],
    'coupe': ['haircut', 'cut'],
    'comprend': ['includes', 'understands'],
    'courte': ['short'],
    'cours': ['class', 'course'],
    'chose': ['anything', 'something', 'thing'],
    'quelque': ['something'],
    'cétait': ['it was'],
    'chambre': ['room'],
    'chambres': ['bedrooms', 'rooms'],
    'cette': ['that', 'this'],
    'café': ['café', 'coffee'],
    'cheveux': ['hair'],
    'ces': ['these'],
    'dans': ['about', 'in'],
    'désirez': ['would you like', 'like'],
    'deviez vous': ['were supposed', 'did you'],
    'devez': ['need', 'must'],
    'descendez': ['get off', 'go down'],
    'depuis': ['how long', 'since', 'for'],
    'déplacer': ['move'],
    'dix neuf': ['seven'],
    'dix huit': ['six'],
    'dois': ['owe', 'need'],
    ...
    'rencontrez vous': ['do you face', 'face'],
    'sortir': ['going out', 'go out'],
    'suivre': ['follow'],
    'soir': ['tonight'],
    'souhaitez': ['would you like', 'would like'],
    'souhaitez vous': ['would you like', 'do you want'],
    'suis': ['am'],
    'si': ['if'],
    ...
    'te': ['you'],
    'très': ['very'],
    'temps': ['how long', 'time', 'weather'],
    'symptômes': ['symptoms'],
    'vélo': ['bike'],
    'visite': ['viewing', 'visit'],
    'voulez': ['want'],
    'voiture': ['car'],
    'voulez vous': ['would you like', 'do you want'],
    'apporter': ['bring'],
    'terminé': ['finished'],
    'pendant': ['for', 'during', 'at'],
    'plus': ['no longer', 'not', 'more'],
    'fois': ['times'],
    'rouge': ['red'],
    'reposez vous': ['rest'],
    'envoyez': ['sending', 'send'],
    'louer': ['rent'],
    'rendez': ['return'],
    'conviendrait': ['would work', 'works'],
    'vendredi': ['friday'],
    'confirmée': ['confirmed'],
    'sûr': ['sure', 'course'],
    'lembarquement': ['boarding'],
    'quelques': ['few', 'some'],
    'déjà': ['before', 'already'],
    'jours': ['days'],
    'jeudi': ['thursday'],
    'lassurance': ['insurance'],
    'équipe': ['team'],
    'étiquette': ['tag', 'label'],
    'fonctionne': ['work', 'works', 'worked'],
    ...
    'ans': ['years', 'years old'],
    'vingt': ['eight', 'twenty'],
    'voilà': ['here is', 'here you are', 'here you go'],
    'vérifier': ['check'],
    'voici': ['here is'],
  };
  ...
  static const _rules = <_AlignmentRule>[
    _AlignmentRule(['ne', 'va', 'pas'], ['wrong']),
    _AlignmentRule(['mal', 'à', 'la', 'tête'], ['headache']),
    _AlignmentRule(['bien', 'sûr'], ['of course']),
    _AlignmentRule(['a', 't', 'il', 'lieu'], ['is', 'it']),
    _AlignmentRule(['je', 'te', 'propose'], ['i', 'suggest']),
    _AlignmentRule(['pièce', "d'identité"], ['identity document']),
    _AlignmentRule(['plus', 'calme'], ['quieter']),
    _AlignmentRule(['vingt', 'heures'], ['eight']),
    _AlignmentRule(['à', 'quatre', 'heures'], ['at', 'four']),
    _AlignmentRule(['tout', 'droit'], ['straight ahead', 'straight ahead']),
    _AlignmentRule(
      ['recommanderiez-vous', 'la', 'même', 'solution'],
      ['would you recommend', 'the', 'same', 'solution'],
    ),
    _AlignmentRule(
      ['je', 'la', 'recommanderais', 'à', 'condition', 'que'],
      ['i', 'it', 'would recommend', 'provided', 'provided', 'that'],
    ),
    _AlignmentRule(
      ['quelles', 'possibilités', 'aviez-vous', 'envisagées'],
      ['what', 'possibilities', 'had you', 'considered'],
    ),
    _AlignmentRule(
      ["j'avais", 'envisagé', 'toutefois'],
      ['i had', 'considered', 'however'],
    ),
    _AlignmentRule(
    ...
    _AlignmentRule(
      ['quelle', 'objection', 'pourrait-on', 'vous', 'faire'],
      ['what', 'objection', 'might', 'someone', 'make'],
    ),
    _AlignmentRule(
      ['on', 'pourrait', 'objecter', 'que', 'mais'],
      ['someone', 'might', 'object', 'that', 'but'],
    ),
    _AlignmentRule(
      ['quels', 'seraient', 'les', 'avantages'],
      ['what', 'would', 'the', 'advantages'],
    ),
    _AlignmentRule(
      ['cela', 'permettrait', 'de', 'tout', 'en'],
      ['that', 'would make it possible', 'to', 'while', 'while'],
    ),
    _AlignmentRule(
      ['quel', 'changement', 'améliorerait', 'votre', 'quotidien'],
      ['what', 'change', 'would improve', 'your', 'daily life'],
    ),
    _AlignmentRule(
      ['je', 'modifierais', 'afin', 'de'],
      ['i', 'would change', 'in order to', 'in order to'],
    ),
    _AlignmentRule(
    ...
    _AlignmentRule(
      ["j'aimerais", 'atteindre', 'cet', 'objectif', 'en'],
      ['i would like', 'to reach', 'this', 'goal', 'by'],
    ),
    _AlignmentRule(
      ['que', "s'est-il", 'passé', 'exactement'],
      ['what', 'happened', 'happened', 'exactly'],
    ),
    _AlignmentRule(
      ['il', "s'est", 'passé', 'que'],
    ...
    _AlignmentRule(
      ['quel', 'événement', 'récent', 'vous', 'a', 'marqué'],
      ['what', 'event', 'recent', 'you', 'stood out', 'stood out'],
    ),
    _AlignmentRule(['avec', 'qui', 'étiez-vous'], ['with', 'who', 'were you']),
    _AlignmentRule(
      ["qu'est-ce", 'que', 'vous', 'avez', 'fait', 'hier'],
      ['what', 'what', 'you', 'did', 'do', 'yesterday'],
    ),
    _AlignmentRule(
      ['je', 'vais', 'y', 'aller', 'avec'],
      ['i', 'am going', 'am going', 'am going', 'with'],
    ),
    _AlignmentRule(
      ['comment', 'ça', 'va', "aujourd'hui"],
      ['how', 'are you', 'are you', 'today'],
    ),
    _AlignmentRule(["aujourd'hui", 'ça', 'va'], ['today', 'feel', 'feel']),
    _AlignmentRule(
      ['à', 'quelle', 'heure', 'commence', 'votre', 'journée'],
      ['what', 'what', 'time', 'start', 'your', 'day'],
    ),
