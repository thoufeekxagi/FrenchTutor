...
class GeminiLiveAudioService {
  ...
  // Same swap as gemini_live_service.dart, same reason: 2.5 Native Audio is
  // Generally Available (3.1 Live is still Preview) and roughly half the
  // audio-output cost, confirmed against this project's own Gemini key
  // before switching.
  static const _model =
  ...
  // v3 invalidates clips generated by the old 3.1 Live model: a different
  // model can render even an identical script with an audibly different
  // take, and mixing 3.1-era and 2.5-era clips for the same word/sentence
  // depending on cache luck is exactly the inconsistency a cache version is
  // for.
  static const _cacheVersion = 'live-audio-v3';
