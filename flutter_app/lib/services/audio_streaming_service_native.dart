...
/// Selected by the conditional import in `audio_streaming_service.dart` on any
/// platform with `dart.library.io` (iOS, Android, desktop).
AudioStreamingService createAudioStreamingService() =>
    NativeAudioStreamingService();
...
class NativeAudioStreamingService implements AudioStreamingService {
