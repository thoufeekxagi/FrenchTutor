class AgentTool {
  ...
  static Map<String, dynamic> _object(Map<String, dynamic> properties, {List<String> required = const []}) => {
        'type': 'OBJECT',
  ...
  static final vocabPalette = [
    AgentTool(
      ...
      parameters: _object({
        'grade': _stringEnum('How well the student recalled/pronounced the word.', values: ['again', 'good', 'easy']),
      }, required: ['grade']),
    ),
  ];
  ...
  static final readingPalette = [
    AgentTool(
      ...
      parameters: _object({
        'grade': _stringEnum('How well the student recalled/pronounced the segment.', values: ['again', 'good', 'easy']),
      }, required: ['grade']),
    ),
  ];
