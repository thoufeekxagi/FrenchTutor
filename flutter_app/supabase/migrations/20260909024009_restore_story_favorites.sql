-- Repair migration for environments whose historical migration ledger marked
-- story_favorites as applied even though the relation was never created.
-- This is additive and preserves any existing bookmarks.
